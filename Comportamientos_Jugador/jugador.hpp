...
class ComportamientoJugador : public Comportamiento
{
  public:
    ...
    template <typename T>
    bool esta_dentro_de_mapa(const casilla c, const vector<vector<T>> &mapa);
    ...
    template <typename T>
    void rotar_mapa_derecha(vector<vector<T>> &mapaOriginal, vector<vector<T>> &mapaGirado);
    casilla rotar_casilla(const casilla c, const size_t size);
    template <typename T>
