...
int main(int argc, char **argv)
{
  ...
  else
  {
    ...
    argumentos.posInicialColaborador.f = atoi(argv[7]);
    argumentos.posInicialColaborador.c = atoi(argv[8]);
    argumentos.posInicialColaborador.brujula = static_cast<Orientacion>(atoi(argv[9]));
